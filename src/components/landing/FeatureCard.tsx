...
const getGlowColorClasses = (glowColor: string) => ({
  border: {
...
export const FeatureCard: React.FC<FeatureCardProps> = memo(({
  ...
  const glowClasses = getGlowColorClasses(glowColor);
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(400px circle at ${mousePosition.x}px ${mousePosition.y}px, ${glowClasses.glow}, transparent 40%)`,
        }}
      />
...
export const FeatureList: React.FC<FeatureListProps> = ({ children, className, ...props }) => {
  return (
    <div
      className={cn(
