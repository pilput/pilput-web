          ...
          <TooltipTrigger asChild>
            {variant === "compact" ? (
              ...
              <motion.button
                ...
                onClick={() => void onClick()}
                className={cn(
                  "inline-flex h-9 shrink-0 items-center gap-2 rounded-md border border-border/80 bg-background px-3 text-sm font-medium text-muted-foreground  transition-colors",
