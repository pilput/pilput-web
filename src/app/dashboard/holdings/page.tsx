...
const HeaderActions = ({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <div className="inline-flex items-center gap-1 rounded-xl border border-border/60 bg-card/60 p-1 dark:bg-muted/20">
        <Button
          variant="ghost"
          size="sm"
      ...
      <Button
        size="sm"
        className="h-9 flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm font-semibold"
        onClick={onOpenAdd}
      >
